...
_require_contains("${_runtime_native_width_test}" "std::uintptr_t marker" "native-width allocator probe marker must follow the 64-bit native pointer width")
_require_contains("${_runtime_native_width_test}" "alignof(PoolProbe) <= alignof(void *)" "native-width allocator probe must not impose stronger-than-pointer alignment")
_require_absent("${_runtime_native_width_test}" "std::uint64_t marker" "allocator probe must use uintptr_t rather than a synthetic fixed-width marker")
