...
Status values: `DONE`, `NEXT`, `PLANNED`, `PARTIAL`, `BLOCKED`.
...
| 01 | Determinism / CRC / Xfer characterization | PARTIAL | CRC + game-logic RNG locked; Xfer primitive + representative snapshot ordering gates implemented with Windows verification pending; layout/replay coverage still required |
