...
{
	AnimParseType animType = static_cast<AnimParseType>(reinterpret_cast<std::uintptr_t>(userData));
...
void W3DModelDrawModuleData::parseConditionState(INI* ini, void *instance, void * /*store*/, const void* userData)
{
	...
	ParseCondStateType cst = static_cast<ParseCondStateType>(reinterpret_cast<std::uintptr_t>(userData));
	switch (cst)
	{
		case PARSE_DEFAULT:
		{
