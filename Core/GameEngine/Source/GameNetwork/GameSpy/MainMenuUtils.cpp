...
{
	Int run = static_cast<Int>(reinterpret_cast<std::intptr_t>(param));
...
static void reallyStartPatchCheck()
{
	...
	ghttpGet(gameURL.c_str(), GHTTPFalse, gamePatchCheckCallback, reinterpret_cast<void *>(static_cast<std::intptr_t>(timeThroughOnline)));
	ghttpGet(mapURL.c_str(), GHTTPFalse, gamePatchCheckCallback, reinterpret_cast<void *>(static_cast<std::intptr_t>(timeThroughOnline)));
	ghttpHead(configURL.c_str(), GHTTPFalse, configHeadCallback, reinterpret_cast<void *>(static_cast<std::intptr_t>(timeThroughOnline)));
	ghttpGet(motdURL.c_str(), GHTTPFalse, motdCallback, reinterpret_cast<void *>(static_cast<std::intptr_t>(timeThroughOnline)));
