...
Write-Host '  cmake --build --preset mingw64-tests --target check_headless_determinism check_evolution_protocol check_evolution_runtime check_evolution_session check_evolution_full_session check_x64_platform'
