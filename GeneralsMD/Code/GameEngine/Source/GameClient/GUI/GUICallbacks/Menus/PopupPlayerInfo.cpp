												...
												UnsignedInt mouse)
{
	...
	Int battleHonor = static_cast<Int>(GadgetListBoxGetItemIntegerData( window, row, col ));
	Int extraValue = static_cast<Int>(GadgetListBoxGetItemIntegerData( window, row - 1, col ));
	if (battleHonor == 0)
	{
